 ...
 * |--------|-------------------------------|-------|---------------------------|--------------------------|
 * | GET    | /api/recurring-bookings       | ADMIN | RECURRING_BOOKING_ENABLED | List recurring bookings  |
 * | GET    | /api/recurring-bookings/:id   | ADMIN | RECURRING_BOOKING_ENABLED | Get single               |
 * | POST   | /api/recurring-bookings       | ADMIN | RECURRING_BOOKING_ENABLED | Create                   |
 * | PATCH  | /api/recurring-bookings/:id   | ADMIN | RECURRING_BOOKING_ENABLED | Update                   |
 * | DELETE | /api/recurring-bookings/:id   | ADMIN | RECURRING_BOOKING_ENABLED | Deactivate               |
 */
...
router.use(requireFeature('RECURRING_BOOKING_ENABLED'));
